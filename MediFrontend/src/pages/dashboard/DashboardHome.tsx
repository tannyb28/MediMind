          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>When your device will need replacement</CardDescription>
              </CardHeader>
              <CardContent>
                <p>Information about the expected lifespan of your device and the replacement process.</p>
              </CardContent>
              <CardFooter>
                <Link to="/dashboard/replacement">
                  <Button>View Details</Button>
                </Link>
              </CardFooter>
            </Card>
            <Card>
              ...
              <CardContent>
                <p>Find answers to common questions about your device, therapy, and daily management.</p>
              </CardContent>
              <CardFooter>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Additional information and support</CardDescription>
              </CardHeader>
              <CardContent>
                <p>Access helpful resources, support groups, and educational materials about your device and therapy.</p>
              </CardContent>
              <CardFooter>
